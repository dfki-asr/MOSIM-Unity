...
namespace UnityIKService
{
    public class IKServiceThriftImpl : UnityAvatarBase, MInverseKinematicsService.Iface
    {
        ...
        protected override void Start()
        {
            ...
            {
                Debug.LogError($"Problem setting up retargeting: The required file: {skelConfigPath} is not available");
                return;
            }
            ...
            try
            {
                ...
                Debug.Log("Retargeting set up successfully");

            }
            catch (Exception e)
            {
                Debug.LogError("Error: Problem at loading the configuration file");
        ...
        public MBoolResponse Setup(MAvatarDescription avatar, Dictionary<string, string> properties)
        {
            ...
            Debug.Log("New Retargeting Successful!");
        ...
        public MIKServiceResult CalculateIKPosture(MAvatarPostureValues postureValues, List<MConstraint> constraints, Dictionary<string, string> properties)
        {
            ...
            float calculateDuration = (float)watch.Elapsed.TotalMilliseconds;
                ...
                if (jointConstraint.GeometryConstraint != null)
                {
                    ...
                    if(jointPosition != null && jointRotation != null)
                    {
                        MainThreadDispatcher.Instance.ExecuteBlocking(delegate
                        {
                            ...
                            Extensions.ApplyFBBIK(jointTypeToGameObject, finalBPIK, jointPosition, jointRotation, jointConstraint.JointType);
            ...
            MMICSharp.Logger.Log(this.logLevel, "Total duration: " + totalDuration + " ms" + " Ik compute duration: " + (totalDuration - calculateDuration) + " ms");
